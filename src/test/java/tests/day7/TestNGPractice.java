...
public class TestNGPractice {
    ...
    public void test(){
        ...
        //if no - it will throw expection and stop the program
        //also ,you will see in the console what was expected
        //what was actually
        //click and hold command button and use left click/single click to open the class
    ...
    //let's verify that Test Automation Practice heading is display
